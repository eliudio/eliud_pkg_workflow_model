...
typedef AssignmentChanged = Function(
  String? value,
  int? privilegeLevel,
);
...
class _AssignmentDropdownButtonWidgetState
  ...
  void didChangeDependencies() {
    bloc = BlocProvider.of<AssignmentListBloc>(context);
...
//        final values = state.values;
            ...
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      items: items,
                      value: value,
                      hint: text(widget.app, context, 'Select a assignment'),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    label: 'Update',
                    onPressed: () {
                      updateComponent(context, widget.app, 'assignments', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<AssignmentListBloc>(context).add(AssignmentChangeQuery(
