...
typedef WorkflowTaskChanged = Function(
  String? value,
  int? privilegeLevel,
);
...
class _WorkflowTaskDropdownButtonWidgetState
  ...
  void didChangeDependencies() {
    bloc = BlocProvider.of<WorkflowTaskListBloc>(context);
...
//        final values = state.values;
            ...
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      items: items,
                      value: value,
                      hint: text(widget.app, context, 'Select a workflowTask'),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    onPressed: () {
                      updateComponent(
                          context, widget.app, 'workflowTasks', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<WorkflowTaskListBloc>(context).add(WorkflowTaskChangeQuery(
